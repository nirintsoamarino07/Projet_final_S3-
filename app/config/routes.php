...
$router->group('', function(Router $router) use ($app) { 
	...
	$router->group('/dons', function() use ($router) {
		...
		$router->post('/vendre', [ DonController::class, 'vendreSubmit' ]);
	});
	...
	$router->group('/attributions', function() use ($router) {
		...
		$router->post('/reset-dispatch', [ AttributionController::class, 'resetDispatch' ]);
	...
	$router->group('/api', function() use ($router) {
		...
		$router->get('/recap', [ RecapController::class, 'stats' ]);
	});
